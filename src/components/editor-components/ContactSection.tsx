...
import { Plus, Trash2, Mail, Phone, MapPin, Github, Linkedin, Globe } from 'lucide-react';
                ...
                <div className="bg-gradient-to-br from-white to-neutral-50 border-2 rounded-xl p-4 space-y-3">
                  <div className="flex gap-3">
                    <select
                      ...
                      className="px-3 py-2 border-2 border-neutral-200 rounded-lg focus:ring-2 focus:ring-blue-500"
                    >
